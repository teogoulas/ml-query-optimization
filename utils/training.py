...
def train_step(input_tensor, target_tensor, enc_hidden, encoder, decoder, optimizer, loss_fn, acc_metric):
    ...
    with tf.GradientTape() as tape:
        loss = model_step_execution(input_tensor, target_tensor, enc_hidden, encoder, decoder, loss_fn, acc_metric)
...
def model_step_execution(input_tensor, target_tensor, enc_hidden, encoder, decoder, loss_fn, acc_metric):
    loss = 0.0
